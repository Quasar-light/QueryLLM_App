...
st.sidebar.markdown('<a style="text-align: center;padding-top: 0rem;" href="mailto: i.build.apps.4.u@gmail.com">:email:</a> Kali Krishanu', unsafe_allow_html=True)
...
st.sidebar.caption("(https://www.darkfemininecreative.com/)")
...
st.sidebar.caption("(https://app.slack.com/client/T062ECJNTLG/C062ECJRBH6)")

st.sidebar.markdown('<a style="text-align: center;padding-top: 0rem;" href="https://www.darkfemininecreative.com/blog-1070">Blog </a> by Kali Krishanu', unsafe_allow_html=True)
...
st.caption("Datasets courtesy of Coding Temple, and Data Analytica")
